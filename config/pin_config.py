...
# RC522 uses the same SPI pins on the Pi (SPI0 + CS). Keep aliases for clarity.
RC522_SPI_MOSI = PN532_SPI_MOSI
RC522_SPI_MISO = PN532_SPI_MISO
RC522_SPI_SCLK = PN532_SPI_SCLK
RC522_SPI_CS = PN532_SPI_CS
RC522_RST = PN532_RSTO
